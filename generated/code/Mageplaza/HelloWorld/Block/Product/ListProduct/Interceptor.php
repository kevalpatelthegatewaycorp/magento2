<?php
namespace Mageplaza\HelloWorld\Block\Product\ListProduct;

/**
 * Interceptor class for @see \Mageplaza\HelloWorld\Block\Product\ListProduct
 */
class Interceptor extends \Mageplaza\HelloWorld\Block\Product\ListProduct implements \Magento\Framework\Interception\InterceptorInterface
{
    use \Magento\Framework\Interception\Interceptor;

    public function __construct(\Magento\Catalog\Block\Product\Context $context, \Magento\Framework\Data\Helper\PostHelper $postDataHelper, \Mageplaza\HelloWorld\Model\Layer\Resolver $layerResolver, \Magento\Catalog\Api\CategoryRepositoryInterface $categoryRepository, \Magento\Framework\Url\Helper\Data $urlHelper, array $data = [])
    {
        $this->___init();
